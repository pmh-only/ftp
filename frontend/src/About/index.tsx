        ...
        <div className="grow flex-1 bg-base-300 rounded-2xl p-6 text-sm font-light flex flex-col justify-end gap-3 items-start">
          <div className="max-w-lg">
            <h2 className="text-2xl font-bold">
              <div>
                The <span className="text-rotate">
                  <span>
            ...
            <p>This server, <a href="#">ftp.io.kr</a> provides a reliable, unrestricted package mirror for <a href="https://archlinux.org/" target="_blank">Arch Linux</a>, a lightweight and flexible Linux® distribution that follows the “Keep It Simple” philosophy.</p>
            <p></p>
          </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-6">
        <div className="grow flex-1 hero bg-base-300 rounded-2xl lg:max-w-xl">
          <div className="mockup-code w-full h-full select-text selection:bg-accent-content">
            <pre data-prefix=">" className="text-accent"><code>You can use this mirror by modifying your mirrorlist file.</code></pre>
